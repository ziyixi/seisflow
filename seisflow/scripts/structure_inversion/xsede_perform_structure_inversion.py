...
def main(base_directory, cmts_directory, ref_directory, windows_directory, data_asdf_directory, data_info_directory,
    ...
    construct_process_kernel_structure(
        join(base_directory, "database"), ref_directory, sem_utils_directory, kernel_process_directory, input_model_directory)
    # * now perform the structure inversion
    result += process_kernel(join(base_directory,
                                  "process_kernel"), sigma_h, sigma_v, n_total)

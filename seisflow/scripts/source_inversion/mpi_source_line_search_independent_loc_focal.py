"""
mpi_source_line_search_independent_loc_focal.py: do the source line searchwith independent loc/focal gradient.
"""
...
from ...setting import (CC_THRESHOLD, DELTAT_THRESHOLD, INIT_POINTS,
                        MAX_DXS_RATIO, N_ITER, RANDOM_STATE, SNR_THRESHOLD,
                        SURFACE_THRESHOLD)
from ...tasks.cmtsolution.make_perturbed_cmtsolution import add_src_frechet
from ...tasks.line_search.line_search_source_independent_loc_focal import \
    line_search
...
from .mpi_source_line_search import load_cmtsolution
...
def get_paths(green_raw_asdf_directory, green_perturbed_asdf_directory_loc, green_perturbed_asdf_directory_focal, data_asdf_directory, windows_directory, data_info_directory, stations_path,
    ...
    all_files_green_perturbed_asdf_directory_loc_this_rank = [
        join(green_perturbed_asdf_directory_loc, gcmtid + ".h5") for gcmtid in all_gcmtids_this_rank]
    all_files_green_perturbed_asdf_directory_focal_this_rank = [
        join(green_perturbed_asdf_directory_focal, gcmtid+".h5") for gcmtid in all_gcmtids_this_rank]
    all_virasdf_green_perturbed_loc_this_rank = []
    all_virasdf_green_perturbed_focal_this_rank = []
    for each_file in all_files_green_perturbed_asdf_directory_loc_this_rank:
        virasdf = VirAsdf()
        virasdf.read_asdf(each_file, lazy=True)
        all_virasdf_green_perturbed_loc_this_rank.append(virasdf)
    for each_file in all_files_green_perturbed_asdf_directory_focal_this_rank:
        virasdf = VirAsdf()
        virasdf.read_asdf(each_file, lazy=True)
        all_virasdf_green_perturbed_focal_this_rank.append(virasdf)
    ...
    return (all_virasdf_green_raw_this_rank, all_virasdf_green_perturbed_loc_this_rank, all_virasdf_green_perturbed_focal_this_rank,
            all_virasdf_data_body_this_rank, all_virasdf_data_surface_this_rank, all_windows_this_rank,
            first_arrival_zr, first_arrival_t, baz, stations, all_files_src_frechet_directory_this_rank,
            all_files_cmtsolution_directory_this_rank, all_files_output_newcmtsolution_directory_this_rank
            )


def convert_input_parameters(alpha_loc_range, alpha_focal_range, t0_range,
    ...
    """
    alpha_loc_range = tuple(map(float, alpha_loc_range.split(",")))
    alpha_focal_range = tuple(map(float, alpha_focal_range.split(",")))
    ...
    return alpha_loc_range, alpha_focal_range, t0_range, tau_range, body_band, surface_band, snr_threshold, cc_threshold, deltat_threshold
...
@click.option('--green_perturbed_asdf_directory_loc', required=True, type=str, help="the directory of the asdf files from the perturbed loc green function cmtsolution")
@click.option('--green_perturbed_asdf_directory_focal', required=True, type=str, help="the directory of the asdf files from the perturbed focal green function cmtsolution")
...
@click.option('--alpha_loc_range', required=True, type=str, help="alpha loc range: min_alpha,max_alpha")
@click.option('--alpha_focal_range', required=True, type=str, help="alpha focal range: min_alpha,max_alpha")
...
def main(green_raw_asdf_directory, green_perturbed_asdf_directory_loc, green_perturbed_asdf_directory_focal, data_asdf_directory, windows_directory, data_info_directory, stations_path,
         src_frechet_directory, cmtsolution_directory, output_newcmtsolution_directory,
         body_band, surface_band, taper_tmin_tmax,
         alpha_loc_range, alpha_focal_range, t0_range, tau_range):
    all_virasdf_green_raw_this_rank, all_virasdf_green_perturbed_loc_this_rank, all_virasdf_green_perturbed_focal_this_rank,\
        all_virasdf_data_body_this_rank, all_virasdf_data_surface_this_rank, all_windows_this_rank,\
        first_arrival_zr, first_arrival_t, baz, stations, all_files_src_frechet_directory_this_rank,\
        all_files_cmtsolution_directory_this_rank, all_files_output_newcmtsolution_directory_this_rank = get_paths(
            green_raw_asdf_directory, green_perturbed_asdf_directory_loc, green_perturbed_asdf_directory_focal, data_asdf_directory, windows_directory, data_info_directory, stations_path,
            src_frechet_directory, cmtsolution_directory, output_newcmtsolution_directory, body_band, surface_band
        )
    ...
    alpha_loc_range, alpha_focal_range, t0_range, tau_range, body_band, surface_band, snr_threshold, \
        cc_threshold, deltat_threshold = convert_input_parameters(alpha_loc_range, alpha_focal_range, t0_range,
                                                                  tau_range, body_band, surface_band, snr_threshold,
                                                                  cc_threshold, deltat_threshold)
    # call the line search script
    each_virasdf_combined = zip(
        all_virasdf_green_raw_this_rank, all_virasdf_green_perturbed_loc_this_rank, all_virasdf_green_perturbed_focal_this_rank, all_virasdf_data_body_this_rank, all_virasdf_data_surface_this_rank, all_windows_this_rank,
    ...
    for (each_virasdf_green_raw, each_virasdf_green_perturbed_loc, each_virasdf_green_perturbed_focal, each_virasdf_data_body,
        ...
        each_virasdf_green_perturbed_loc.revoke()
        each_virasdf_green_perturbed_focal.revoke()
        ...
        n_iter = N_ITER
        weighted_similarity_raw, optimizer_max = line_search(alpha_loc_range, alpha_focal_range, t0_range, tau_range, each_virasdf_green_raw, each_virasdf_green_perturbed_loc, each_virasdf_green_perturbed_focal, each_virasdf_data_body, each_virasdf_data_surface,
